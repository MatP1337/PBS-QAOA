...
from classical_cost_func import cost_function as cf, format_coeffs
from classical_cost_func_QUBO import cost_function,  cost_symp
import numpy as np
...
cl_cost = cf(tot_coeff,M,N,PBS_graph)
...
depth = 3
res = qaoaPBS.run(q_array, depth,  max_iter = 100, mes_kwargs = {'shots':5000})
